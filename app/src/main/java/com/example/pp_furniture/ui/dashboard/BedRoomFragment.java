...
public class BedRoomFragment extends Fragment {
    ...
    private void createList() {
        list_bedroom.add(new FurnitureModel("Спальня","Кровать Pink Flame", "1690",
                "Кровать двухспальная размер 2.6м х 2.4м производство Турция," +
                        " матрас набивной пружинный, кокосовая стружка", R.drawable.pink_1));
        list_bedroom.add(new FurnitureModel("Спальня","Кровать sunrise", "1100",
                " производство Италия, размер 2.6м х 2.4м" + " Mario Fabric " + "отделка: натуральнаая кожа  и гобелен," +
                        "набивной, специальный состав"
                , R.drawable.pink_2));
        list_bedroom.add(new FurnitureModel("Спальня","Кровать Plot", "1340",
                " производство Италия, размер 2.2м х 2.15м" + " Riotello " + "отделка: хлопок и гобелен," +
                        "набивной, специальный состав"
                , R.drawable.pink_3));
        list_bedroom.add(new FurnitureModel("Спальня","Кровать Parlament", "1200",
                " производство Италия, размер 2.2м х 2.4м" + "Mario Fabric " + "отделка: хлопок и атлас," +
                        "набивной, специальный состав"
                , R.drawable.pink_4));
        list_bedroom.add(new FurnitureModel("bed_room","Кровать lottie", "1100",
                " производство Италия, размер 2.6м х 2.4м" + " Mario Fabric " + "отделка: натуральнаая кожа  и гобелен," +
                        "набивной, специальный состав"
                , R.drawable.pink_5));
        list_bedroom.add(new FurnitureModel("Спальня","Кровать floww", "1340",
                " производство Италия, размер 2.2м х 2.15м" + " Riotello " + "отделка: хлопок и гобелен," +
                        "набивной, специальный состав"
                , R.drawable.pink_6));
        list_bedroom.add(new FurnitureModel("Спальня","Кровать morpl", "1200",
                " производство Италия, размер 2.2м х 2.4м" + "Mario Fabric " + "отделка: хлопок и атлас," +
                        "набивной, специальный состав"
                , R.drawable.pink_7));
